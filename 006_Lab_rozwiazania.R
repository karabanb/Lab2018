...
dim(cases[!is.na(LoanAmount) & Product == "Credit card" & LoanAmount != Principal, 1:7])
head(cases[!is.na(LoanAmount) & Product == "Cash loan", 1:7])
...
cases[,.(Land,GDPPerCapita, MeanSalary)]
